 ...
 */
let walkingChallenges: [String] = ["Walk 3 miles a day", "complete 10,000 steps daily"]

let runningChallenges: [String] = ["Run 3 miles 4 times a week", "Complete a 5k in under 30 minutes"]
