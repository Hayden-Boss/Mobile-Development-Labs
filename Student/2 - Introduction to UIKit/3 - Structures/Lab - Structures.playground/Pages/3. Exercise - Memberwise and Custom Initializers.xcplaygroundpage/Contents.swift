...
var favoriteBook = Book(title: "The Hatchet", author: "Gary Paulsen", pages: 192, price: 5.41)
print("My favorite book is called \(favoriteBook.title), written by \(favoriteBook.author) and is \(favoriteBook.pages) pages long. I paid $\(favoriteBook.price) for it.")
/*:
...
var myHeight = Height(heightInCentimeters: 172.72)
