...
var rectangle1 = Rectangle(width: 15, height: 4)
...
struct Height {
    var heightInInches: Double {
        didSet { if heightInCentimeters != heightInInches * 2.54 {
...
print(myHeight)
myHeight.heightInInches = 1000
print(myHeight)
myHeight.heightInCentimeters = 1000
print(myHeight)
/*:
