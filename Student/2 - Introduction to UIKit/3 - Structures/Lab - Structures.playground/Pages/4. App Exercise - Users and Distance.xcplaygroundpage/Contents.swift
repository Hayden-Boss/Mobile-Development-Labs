...
var hayden = User(name: "Hayden", age: 21, height: 1.72, weight: 75, activityLevel: 5)
print(hayden)
/*:
...
let nauticalMile = Distance(meters: 1852)
print(nauticalMile.feet)
print(nauticalMile.meters)
/*:
