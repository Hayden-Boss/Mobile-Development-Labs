...
let oldHR4 = 70
if var hr = heartRate {
    var hrAverage = (oldHR1 + oldHR2 + oldHR3 + oldHR4 + hr) / 5
    print("The average heart rate with the new value is \(hrAverage)")
} else {
    var hrAverage = (oldHR1 + oldHR2 + oldHR3 + oldHR4) / 4
    print("The average heart rate with only the old values is \(hrAverage)")
}
/*:
