...
let peeps = ["jojo", "bert", "alice", "bob", "chris"]
let sortedCollection1 = peeps.sorted(by: forwards)
...
let sortedCollection2 = peeps.sorted { (name1: String, name2: String) -> Bool in
    return name1 < name2
}
...
let sortedCollection3 = peeps.sorted(by: <)
